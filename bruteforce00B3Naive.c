...
int main(int argc, char *argv[])
{
    ...
    // Enfoque "naive" para la búsqueda de la clave
    // El espacio de claves se divide equitativamente entre los procesos
    // Cada proceso busca secuencialmente en su segmento asignado
